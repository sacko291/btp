...
import { DataRowClient } from '@/components/clients/data';
...
const page = () => {
  ...
  return (
    ...
    <div className=' m-5 border border-cyan-400 p-7 rounded-md shadow-md'>
        <h1 className='text-3xl m-4'>Mes Client</h1>
        ...
        <div className='border border-cyan-400 rounded-md m-4 no-scrollbar'>
            <table className='cursor-pointer w-full'>
                <thead className='bg-cyan-400 border-b-4 border-cyan-800'>
                    <tr>
                        <th className=' text-center w-auto px-4 py-1'>Siren</th>
                        <th className=' text-center w-auto px-4 py-1'>Forme Juridique</th>
                        <th className=' text-center w-auto px-4 py-1'>Denomination Social</th>
