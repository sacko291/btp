...
export function EditFactureAccueil () {
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button variant="outline" className="bg-cyan-500 p-4 text-2xl">Nouvelle Facture</Button>
      </DialogTrigger>
      <DialogContent className="w-4/5">
        <DialogHeader>
          <DialogTitle>Creer une nouvelle Facture </DialogTitle>
          <DialogDescription>
            Veuillez renseignez les informations de la nouvelle facture 
          </DialogDescription>
        </DialogHeader>
